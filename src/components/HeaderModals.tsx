...
### 项目背景
埃菲尔铁塔作为巴黎永久性地标，自 1985 年起每年冬季都会点亮闪烁灯光。光影大师设计团队于 2023 年受邀对闪烁系统进行升级，使其更加节能环保且视觉效果更为震撼。
...
每年约有 700 万游客专程在整点时分段观赏闪烁灯光，铁塔周边 3 公里范围内均可清晰可见。`,
  ...
  },
  {
    name: "外滩万国建筑灯光群",
    location: "中国上海 · 黄浦江畔",
    desc: "Art-Deco 古典立面以暖金 2700K 退晕擦墙，将百年砖石重新赋予夜色尊贵。光影大师团队历时 18 个月，为外滩 12 栋国家级历史保护建筑量身定制了「见光不见灯」的极致洗墙方案，完美呈现海派文化与万国建筑的美学交融。",
    fullArticle: `## 外滩万国建筑灯光群

### 项目意义
外滩万国建筑博览群是上海最具标志性的历史文化遗产。2023 年，光影大师设计团队受上海市黄浦区政府邀请，为外滩 12 栋核心建筑进行夜景照明升级改造。
...
灯光设计深度融合海派文化元素，在和平饭店、浦东发展银行等地标建筑上，通过极精准的擦墙洗光，将石材纹理、浮雕细节完美呈现，仿佛为百年建筑披上一层温柔的金色薄纱。`,
  ...
  },
  {
    ...
    desc: "激光、水舞与摩天楼灯光三位一体实时音画同步，打造城市级数字媒体节日。滨海湾灯光秀是新加坡年度标志性盛事，光影大师团队负责整体中控系统设计与激光阵列编排。",
    fullArticle: `## 新加坡滨海湾灯光秀

### 项目规模
新加坡滨海湾灯光秀（i Light Singapore）是亚洲最具影响力的数字灯光艺术节。光影大师设计团队负责核心区域——滨海湾金沙酒店外立面及漂浮舞台的整体灯光设计方案。
...
### 文化尊重
谢赫扎耶德大清真寺是伊斯兰世界最具影响力的宗教建筑之一。光影大师设计团队在方案设计之初，便深入研习伊斯兰建筑美学原则，确保每一束光都符合宗教场所的神圣氛围。
...
「少即是多」——用最克制的灯光介入，呈现最极致的光影魅力。夜间远眺，清真寺如同一颗漂浮在沙漠中的发光宝石，纯净、神圣、永恒。`,
  ...
  },
  {
    name: "京都金阁寺雪景投光",
    location: "日本 · 京都",
    desc: "3900K 月光冷色系精准反射于金箔与水面，极简克制地营造出禅宗宁静。光影大师团队与京都市政府合作，为这座国宝级世界文化遗产量身定制了「雪月花」三景照明方案。",
    fullArticle: `## 京都金阁寺雪景投光

### 遗产保护
金阁寺（鹿苑寺）是日式禅宗美学的巅峰之作，寺身通体贴有纯金箔。光影大师设计团队历时 2 年，进行了 17 轮 1:1 实体模型光效测试，最终确定「不触碰一片金箔」的极致非侵入式安装方案。
...
### 光影大师方案
光影大师团队将线性 RGBW 像素条完美隐藏于幕墙竖肋型材内部，平时完全隐形。每晚 20:00-22:30，幕墙自动演绎「数据流动」主题的动态流光。22:30 后自动退晕至 15% 亮度，深夜 00:00 后仅保留 5% 安全照明。
...
### 文物保护之难
中国现存元代以前古建筑仅 427 处，每一处都是不可再生的文化瑰宝。传统灯光安装需要在木构上打孔固定，这对古建的寿命是致命的。李明远会长三年来拒绝了 17 家照明企业的方案，直到遇见光影大师。

### 光影大师突破
光影大师的专利「无痕重力抱箍系统」利用古建自有结构受力，通过精密计算抱箍与木材的接触压强（<0.15 MPa），确保数十年不伤木骨。同时选用 2200K 超低色温，将蓝光辐射（损伤彩画的主因）降至仪器无法检测的水平。
...
### 暗天空保护
斐济莫米湾是全球最佳的暗夜保护区之一。喜多度假村（Six Senses）作为全球顶尖的生态度假品牌，将「零光害」写入了品牌标准。光影大师团队历时 14 个月，与天文学家、生态学家联合研发，打造出全球首个「暗天空三星认证」的度假村照明系统。
...
export const WORKFLOW_STEPS = [
  {
    step: 1,
    title: "需求沟通与场地勘察",
    desc: "深入了解建筑载体、环境生态、业主审美偏好和预算范围。光影大师勘察团队携带 Dialux 现场采点设备、光谱分析仪、暗天空合规检测仪，进行为期 1-3 天的全方位现场勘察。",
...
《场地勘察报告》——包含 30+ 项参数指标、120+ 张现场照片、5 年期光照变化模拟动画。`,
  ...
  },
  {
    ...
    desc: "基于现场数据生成照度模拟、色温规划和效果预览渲染。光影大师创意团队运用 Dialux 4.0 和 Relux 专业级光模拟软件，生成 1:1 真实施工级照度模拟图。",
...
### 汇报演示
光影大师独创「沉浸式方案汇报系统」——在会议室搭建 1:1 实景光环境模拟空间，让业主提前「走进」完工后的夜景效果。`,
  ...
  },
  {
    step: 3,
    title: "深化设计与灯具选型",
    desc: "精确到每颗灯的型号、角度、色温与安装方式的工程级图纸。光影大师深化设计团队由 12 位平均从业 14 年的资深照明工程师组成，确保每一张施工图都可直接指导现场安装。",
...
- 施工配合：全程驻场工程师`,
  ...
  },
  {
    step: 4,
    title: "非侵入式施工安装",
    desc: "采用专利抱箍与压载工艺，对古建零损伤，对幕墙零破坏。光影大师自有施工团队均持有「古建筑照明施工资质证书」，平均从业 9 年，是中国最资深的照明施工力量。",
...
- 业主手机 APP 实时查看施工进度`,
  ...
  },
  {
    step: 5,
    title: "调光与 DMX 中控编程",
    desc: "16-Bit 对数调光曲线编写、多时段场景编排与暗天空合规验证。光影大师中控编程团队由 8 位 DMX 国际认证工程师组成，累计编程通道数超过 120 万。",
...
- 暗天空合规验收（上射光通量占比 <1.5%）`,
  ...
  },
  {
    step: 6,
    title: "验收交付与长期运维",
    desc: "IDA 暗天空合规认证、操作培训、远程运维及年度光衰校准。光影大师提供「5+5」双五年的全周期运维承诺，确保灯光系统在 10 年内始终保持设计效果。",
    fullArticle: `## 第六步：验收交付与长期运维

### 交付文档
- 《光影大师照明系统操作手册》（含 iPad 一键控制指南）
...
### 客户满意度
光影大师交付项目客户满意度：99. 7%（2020-2025 年均）`,
            ...
            <div className="flex flex-col gap-0 relative">
              ...
              <div className="mt-3 p-4 bg-cyan-950/10 border border-cyan-500/15 rounded-xl flex items-center gap-3">
                ...
                <p className="text-xs text-neutral-300 leading-relaxed">
                  从初勘到验收，光影大师标准交付周期为 <b className="text-cyan-400">4-8 周</b>。
