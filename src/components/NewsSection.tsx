...
const DEFAULT_STANDARD_ARTICLES: StandardArticle[] = [
  {
    id: "std-1",
    title: "文旅光影创新：夜游照度分区与沉浸式秀演技术规范",
    summary: "从景区亮化到沉浸式光影夜游，文旅光影设计需遵循照度分区、投影参数与 DMX512 联动的真实工程标准。",
    content: `文旅光影创新正成为夜游经济的核心驱动力。通过文旅光影设计，景区可在夜间重塑叙事场景，将水幕灯光秀、灯光装置艺术、互动投影与在地文化结合，形成差异化夜游体验。

【照度分区真实参数】依据 CIE 150 与国内城市照明规划，夜游动线按环境亮度分级：
· 入口广场 / 主秀区：地面照度 50–100 lx，立面重点照明 150–300 lx
· 叙事步道：5–15 lx（保留暗区制造节奏）
· 生态敏感区：≤3 lx，上射光比例 ULOR=0（符合 DarkSky 认证）

【水幕灯光秀技术要点】需统筹喷头、水幕、激光与投影：投影设备流明≥18000，水幕宽 10–15m、厚 2–3mm，整系统防护等级 IP65 以上，控制协议采用 DMX512 / RDM，刷新帧率 ≥30fps 保证同步无拖影。

【灯光装置艺术】强调原创性、结构安全与维护可达性，常应用于城市广场、商业综合体与主题公园，风荷载按 50 年一遇校核。

国际层面需满足 IEC 60598-2-5 户外灯具安全；国内依据 GB 7000.1-2015、GB/T 31832《LED 城市道路照明应用技术要求》及地方夜景导则，对色温（推荐 2700K–4000K）、亮度、动态变化速率做分区管控。`,
    coverImage: "https://images.unsplash.com/photo-1515630278258-407f66498911?w=800&q=80",
    tags: ["文旅光影创新", "文旅光影设计", "水幕灯光秀", "灯光装置艺术", "夜游经济"],
    color: "purple",
  ...
  {
    id: "std-2",
    title: "酒店外观灯光与展厅灯光设计：防眩、显色与照度梯度",
    summary: "酒店外观灯光、展厅灯光设计与办公楼灯光设计的技术底线——UGR<19、Ra≥90 与 GB 50034 照度梯度。",
    content: `酒店外观灯光是建筑夜间「第二张脸」。国际标准 CIE 建议外墙平均亮度 15–35 cd/m²，并须避免对客房产生光侵扰（居室窗户外表面垂直照度 ≤10 lx）。

【防眩核心指标】统一眩光值 UGR<19（CIE 117），采用二次配光灯具、遮光角 ≥30°，光源本体不可直视。立面洗墙常用 2700K–3200K 暖白，突出材质肌理而非均匀铺亮。

【展厅灯光设计照度梯度】依据展品属性分级（GB 50034-2013 / JGJ/T 119）：
· 主展品重点照明：500–800 lx
· 背景墙 / 过渡区：≤200 lx，形成层次
· 博物馆级：显色指数 Ra≥90，色温 2700K–4000K 可调，紫外含量 ≤10 μW/lm、红外近零
常用轨道射灯 + 蜂窝防眩网 + 智能调光，闭馆后降至养护照度。

【办公楼灯光设计】以功能性为主，入口标识、立面韵律与节能控制结合，常用 LED 投光灯与线性洗墙灯，色温 3500K–4000K，接入楼宇智能做平日 / 深夜两档场景。

国内 GB 50034《建筑照明设计标准》对各功能空间照度、均匀度、眩光限制均有强制规定，寺庙佛教设计在酒店外观灯光、展厅灯光设计、办公楼灯光设计中严格对接国际及国内灯光标准。`,
...
function LightStandardsBoard() {
  ...
  const addArticle = () => {
    const newArticle: StandardArticle = {
      ...
      title: "新文章标题",
      summary: "输入文章摘要...",
      content: "输入正文内容，支持多行。可植入文旅光影创新、酒店外观灯光、展厅灯光设计等专业关键词。",
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-[10px] text-neutral-500 mt-0.5">
              {isLoggedIn ? "已登录 · 可上传 · 可编辑 · 自动保存" : "聚焦文旅光影创新、酒店外观灯光、展厅灯光设计等17大专业领域"}
            </p>
          </div>
          {isLoggedIn && (
            <button
