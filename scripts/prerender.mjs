...
const ROUTES = [
  {
    path: '/',
    title: '禅境设计-专业寺庙设计|汉传佛教设计|道教宫观设计|寺庙建筑设计',
    description: '禅境设计专注专业寺庙设计，提供汉传佛教设计、道教宫观设计、藏传佛教设计、南传佛教设计、寺庙建筑设计、寺庙室内设计、寺庙软装设计、寺庙造型雕塑设计、寺庙景观设计、寺庙灯光设计。形制合规，全流程一体化设计。',
    keywords: '寺庙设计,专业寺庙设计,汉传佛教设计,道教宫观设计,藏传佛教设计,南传佛教设计,寺庙建筑设计,寺庙室内设计,寺庙软装设计,寺庙雕塑设计,寺庙景观设计,寺庙灯光设计,寺院规划设计,宗教建筑设计,寺庙设计院',
    type: 'website',
    staticContent: `
      <header>
        <h1>禅境设计 | ZENSPACE DESIGN — 专业寺庙设计机构</h1>
        <p>寺庙设计 · 寺院规划设计 · 汉传佛教设计 · 道教宫观设计 · 藏传佛教设计 · 南传佛教设计 · 寺庙建筑 · 寺庙室内 · 寺庙景观 · 寺庙灯光</p>
      </header>
      <main>
        <section>
          <h2>关于禅境设计</h2>
          <p>禅境设计（ZENSPACE DESIGN）是专注宗教空间营造的专业寺庙设计机构。我们深研汉传佛教、道教、藏传佛教、南传佛教四大体系的建筑形制与仪轨规范，提供从总体规划、建筑设计、室内陈设、造像雕塑到景观园林、灯光亮化的全流程一体化设计服务。</p>
        ...
        <section>
          <h2>设计与规范标准</h2>
          <p>禅境设计严格遵循国家现行规范，包括 GB 50016《建筑设计防火规范》、GB 50034《建筑照明设计标准》、JGJ/T 163《城市夜景照明设计规范》、GB 50763《无障碍设计规范》、GB 50165《古建筑木结构维护与加固技术规范》。在形制法度上依据宋《营造法式》与清《工程做法则例》进行材分与举折推算，造像依据《造像量度经》校核。</p>
        </section>
        <section>
          <h2>服务流程</h2>
          <ol>
        ...
        <section>
          <h2>为什么选择禅境设计</h2>
          <p>禅境设计的核心能力在于把宗教仪轨转化为可落地的空间语言。我们既懂伽蓝七堂制、曼陀罗图式、造像量度经，也懂消防规范、结构计算与施工工艺。这种「传统法度 + 当代技术」的双重能力，是寺庙设计最稀缺也最关键的素质。</p>
        </section>
        <section>
          <h2>常见问题</h2>
          <h3>寺庙设计收费标准是什么？</h3>
          <p>禅境设计提供专业寺庙设计效果图服务，完整项目根据建筑面积、单体数量、设计深度与地形复杂度综合评估报价。</p>
          <h3>寺庙建设需要办理哪些审批？</h3>
    ...
    faq: [
      { q: '寺庙设计收费标准是什么？', a: '禅境设计提供专业寺庙设计效果图服务，完整项目根据建筑面积、单体数量、设计深度与地形复杂度综合评估报价。' },
  ...
  {
    path: '/tech',
    title: '技术专栏-寺庙设计专业技术指南|营造法式|造像量度|禅境设计',
    description: '禅境设计技术专栏，分享寺庙设计专业技术知识：寺庙建筑设计指南、寺庙灯光设计指南、寺庙设计审批与规范指南、营造法式推算、造像量度经等实用内容。',
    ...
    staticContent: `
      ...
      <main>
        <section>
          <h2>寺庙设计专业技术文章</h2>
          <p>禅境设计技术专栏汇聚寺庙设计与宗教空间营造的专业知识和实战经验，涵盖寺庙建筑设计、寺庙灯光设计、审批与规范、营造法式推算、造像量度经等核心技术话题。</p>
        </section>
        <section>
          <h2>热门技术文章</h2>
          <ul>
  ...
  },
  {
    ...
    title: '寺庙建筑设计完整指南：从形制法度到落地施工|禅境设计',
  ...
  },
  {
    ...
    title: '寺庙灯光设计指南：见光不见灯的克制美学|禅境设计',
    ...
    staticContent: `
      ...
      <main>
        ...
        <section>
          ...
          <p>禅境设计可协助筹建方准备全套设计文件与技术说明，并配合各部门的技术审查沟通。</p>
        </section>
      </main>`,
  },
  {
    path: '/art',
    title: '营造实录-寺庙设计案例赏析|寺院营造实录|禅境设计',
    description: '禅境设计营造实录栏目，精选寺庙设计与寺院营造案例：汉传寺院、道教宫观、藏传佛殿、南传佛寺的建筑、室内、景观与灯光实录，展示宗教空间营造的专业水准。',
    ...
    staticContent: `
      ...
      <main>
        <section>
          <h2>寺庙设计案例库</h2>
          <p>禅境设计精选寺庙设计与寺院营造实录，涵盖汉传佛教寺院、道教宫观、藏传佛殿、南传佛寺等多个体系，以及建筑、室内、景观、造像、灯光等专业板块，为筹建方与设计从业者提供专业参考。</p>
        </section>
        <section>
          <h2>精选营造实录</h2>
          <ul>
  ...
  {
    path: '/interview',
    title: '筹建方访谈-寺庙设计项目专访|寺院营造经验|禅境设计',
    description: '禅境设计筹建方访谈栏目，分享寺庙设计项目的真实反馈与营造经验。汉传寺院、道教宫观、藏传佛殿、南传佛寺筹建方专访，了解寺庙设计的实际价值。',
    ...
    staticContent: `
      ...
      <main>
        <section>
          <h2>真实筹建方声音</h2>
          <p>禅境设计深入采访多位寺庙设计项目的筹建方与寺院管理者，分享他们从形制研究、方案沟通到项目落地的完整体验，以及专业设计为宗教空间带来的实际价值。</p>
        </section>
        <section>
          <h2>访谈实录</h2>
          <ul>
  ...
  {
    path: '/workflow',
    title: '服务流程-寺庙设计实施步骤|专业寺庙设计流程|禅境设计',
    description: '禅境设计寺庙设计服务流程详解：需求沟通→形制研究→概念方案→深化设计→施工配合→竣工验收。六步标准化流程确保每个项目高品质交付。',
    ...
    staticContent: `
      ...
      <main>
        <section>
          <h2>六步标准化设计流程</h2>
          <p>禅境设计采用六步标准化寺庙设计服务流程，从需求沟通到竣工验收，确保每个项目高品质交付。相比一般建筑设计，寺庙设计多了「形制研究」这一步，这是保证形制纯正的关键。</p>
        </section>
        <section>
          <h2>第一步：需求沟通</h2>
